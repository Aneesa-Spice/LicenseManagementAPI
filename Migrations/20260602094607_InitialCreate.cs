        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LicenseQuantity = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PolicyId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ProviderPolicyId = table.Column<string>(type: "text", nullable: false),
                    PolicyName = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DurationValue = table.Column<string>(type: "text", nullable: true),
                    Duration = table.Column<long>(type: "bigint", nullable: true),
                    Scheme = table.Column<string>(type: "text", nullable: true),
                    Floating = table.Column<bool>(type: "boolean", nullable: false),
                    MaxMachines = table.Column<int>(type: "integer", nullable: true),
                    MaxProcesses = table.Column<int>(type: "integer", nullable: true),
                    MaxCPUCores = table.Column<int>(type: "integer", nullable: true),
                    MaxMemory = table.Column<int>(type: "integer", nullable: true),
                    MaxDisc = table.Column<int>(type: "integer", nullable: true),
                    MaxUsers = table.Column<int>(type: "integer", nullable: true),
                    MaxUses = table.Column<int>(type: "integer", nullable: true),
                    ProductId = table.Column<int>(type: "integer", nullable: true),
                    ProviderProductId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LicenseId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ProviderLicenseId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    ...
                    ProviderPolicyId = table.Column<string>(type: "text", nullable: true),
                    CompanyId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Licenses_Policies_PolicyId",
                        column: x => x.PolicyId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderMachineId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    MachineFingerprint = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Activations_ProviderMachineId",
                table: "Activations",
                column: "ProviderMachineId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Policies_ProviderPolicyId",
                table: "Policies",
                column: "ProviderPolicyId",
                unique: true);
